  ...
  return (
    <div className="p-5 rounded-2xl bg-[#111827] border border-gray-800 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="md:col-span-2 bg-slate-900/60 p-4 rounded-xl border border-gray-800 flex flex-col justify-between">
          <div className="flex justify-between items-center text-xs text-gray-400 mb-4">
            <span>Annual Landslide Incidences in NER</span>
            <span className="text-rose-400 flex items-center gap-1 font-semibold">
              <TrendingUp className="w-3.5 h-3.5" /> +138% Surge Since 2018
            </span>
          </div>

          <div className="flex items-end justify-between gap-2 h-44 pt-4 px-2 border-b border-gray-800">
            {yearlyData.map((d) => (
              <div key={d.year} className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end">
                <span className="text-[10px] text-gray-400 font-mono">{d.events}</span>
                <div
                  className="w-full max-w-[28px] rounded-t-md bg-gradient-to-t from-sky-600 via-sky-500 to-rose-500 transition-all hover:opacity-80"
                  style={{ height: d.height }}
                  title={`${d.year}: ${d.events} events (${d.severe} severe)`}
                ></div>
                <span className="text-[10px] text-gray-400 font-mono mt-1">{d.year}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-slate-900/60 p-4 rounded-xl border border-gray-800 space-y-3">
          <h4 className="text-xs font-bold text-gray-300 uppercase tracking-wider">Top Vulnerable States</h4>
          <div className="space-y-2.5 text-xs">
            <div>
              ...
              <div className="w-full bg-gray-800 h-1.5 rounded-full overflow-hidden">
                <div className="bg-rose-500 h-full w-[28.5%]"></div>
              </div>
            </div>
            <div>
              <div className="flex justify-between text-gray-300 mb-1">
              ...
              <div className="w-full bg-gray-800 h-1.5 rounded-full overflow-hidden">
                <div className="bg-orange-500 h-full w-[24.2%]"></div>
              </div>
            </div>
            <div>
              <div className="flex justify-between text-gray-300 mb-1">
              ...
              <div className="w-full bg-gray-800 h-1.5 rounded-full overflow-hidden">
                <div className="bg-amber-500 h-full w-[18.1%]"></div>
              </div>
            </div>
            <div>
              <div className="flex justify-between text-gray-300 mb-1">
              ...
              <div className="w-full bg-gray-800 h-1.5 rounded-full overflow-hidden">
                <div className="bg-emerald-500 h-full w-[21.0%]"></div>
              </div>
            </div>
          </div>
        </div>
